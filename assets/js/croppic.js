...
(function (window, document) {
	...
	Croppic.prototype = {
		...
		createImgUploadControls: function(){
			...
			//if(that.options.btnTitle!==''){cropControlUpload = '<span class="cropControlUpload">'+that.options.btnTitle+'</span>';}
		...
		bindImgUploadControl: function(){
			...
			that.form.find('input[type="file"]').change(function(){
				if(that.form.find('input[type="file"]')[0].files[0]["size"] > 800000){
					make_message("Error","Este archivo supera el maximo permitido de 800 kb");
					return;
				}
