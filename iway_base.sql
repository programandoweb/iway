...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-04-2019 a las 19:01:10
...
--
-- Base de datos: `iway_db2`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `cf_ciclos_pagos`
--
...
--
-- Estructura de tabla para la tabla `mae_administrativo`
--
...
--
-- Estructura de tabla para la tabla `mae_asociado`
--
...
--
-- Estructura de tabla para la tabla `mae_calendario`
--
...
--
-- Estructura de tabla para la tabla `mae_centro_costo`
--
...
--
-- Estructura de tabla para la tabla `mae_cliente_joberp`
--
...
--
-- Estructura de tabla para la tabla `mae_cuenta_bancaria`
--
...
--
-- Estructura de tabla para la tabla `mae_forma_de_pago`
--
...
--
-- Estructura de tabla para la tabla `mae_inventario`
--
...
--
-- Estructura de tabla para la tabla `mae_pes_inventario`
--
...
--
-- Estructura de tabla para la tabla `mae_proveedores`
--
...
--
-- Estructura de tabla para la tabla `mae_usuarios_empleados`
--
...
--
-- Estructura de tabla para la tabla `op_links`
--
...
--
-- Estructura de tabla para la tabla `rp_operaciones`
--
...
--
-- Estructura de tabla para la tabla `sys_arl`
--
...
--
-- Estructura de tabla para la tabla `sys_bancos`
--
...
--
-- Volcado de datos para la tabla `sys_bancos`
--
...
--
-- Estructura de tabla para la tabla `sys_caja_comp`
--
...
--
-- Estructura de tabla para la tabla `sys_codigos_cup`
--
...
--
-- Estructura de tabla para la tabla `sys_eps`
--
...
--
-- Estructura de tabla para la tabla `sys_estado_civil`
--
...
--
-- Estructura de tabla para la tabla `sys_gastos_generales`
--
...
--
-- Estructura de tabla para la tabla `sys_iva`
--
...
--
-- Estructura de tabla para la tabla `sys_municipios`
--
...
--
-- Estructura de tabla para la tabla `sys_otros_ingresos`
--
...
--
-- Estructura de tabla para la tabla `sys_paises_mundo`
--
...
--
-- Estructura de tabla para la tabla `sys_profesiones`
--
...
--
-- Estructura de tabla para la tabla `sys_puc`
--
...
--
-- Estructura de tabla para la tabla `sys_retenciones`
--
...
--
-- Estructura de tabla para la tabla `sys_roles_modulos`
--
...
--
-- Estructura de tabla para la tabla `sys_tipo_contrato`
--
...
--
-- Estructura de tabla para la tabla `sys_tipo_identidad`
--
...
--
-- Estructura de tabla para la tabla `sys_tipo_usuario`
--
...
--
-- Estructura de tabla para la tabla `sys_trm`
--
...
--
-- Estructura de tabla para la tabla `sys_und_medida`
--
...
--
-- Indices de la tabla `cf_ciclos_pagos`
--
...
--
-- Indices de la tabla `mae_administrativo`
--
...
--
-- Indices de la tabla `mae_asociado`
--
...
--
-- Indices de la tabla `mae_calendario`
--
ALTER TABLE `mae_calendario`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `mae_centro_costo`
--
...
--
-- Indices de la tabla `mae_cliente_joberp`
--
...
--
-- Indices de la tabla `mae_cuenta_bancaria`
--
...
--
-- Indices de la tabla `mae_forma_de_pago`
--
...
--
-- Indices de la tabla `mae_inventario`
--
...
--
-- Indices de la tabla `mae_pes_inventario`
--
...
--
-- Indices de la tabla `mae_proveedores`
--
...
--
-- Indices de la tabla `mae_usuarios_empleados`
--
...
--
-- Indices de la tabla `sys_municipios`
--
ALTER TABLE `sys_municipios`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `sys_otros_ingresos`
--
ALTER TABLE `sys_otros_ingresos`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `sys_paises_mundo`
--
ALTER TABLE `sys_paises_mundo`
  ADD PRIMARY KEY (`pais_id`);

--
-- Indices de la tabla `sys_profesiones`
--
ALTER TABLE `sys_profesiones`
  ADD PRIMARY KEY (`profesion_id`);

--
-- Indices de la tabla `sys_puc`
--
ALTER TABLE `sys_puc`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `sys_retenciones`
--
...
--
-- Indices de la tabla `sys_roles_modulos`
--
ALTER TABLE `sys_roles_modulos`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `sys_session`
--
...
--
-- Indices de la tabla `sys_tipo_contrato`
--
ALTER TABLE `sys_tipo_contrato`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `sys_tipo_identidad`
--
ALTER TABLE `sys_tipo_identidad`
  ADD PRIMARY KEY (`tipo_identidad_id`);

--
-- Indices de la tabla `sys_tipo_usuario`
--
ALTER TABLE `sys_tipo_usuario`
  ADD PRIMARY KEY (`type_id`);

--
-- Indices de la tabla `sys_trm`
--
ALTER TABLE `sys_trm`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `sys_und_medida`
--
...
--
-- Filtros para la tabla `mae_asociado`
--
ALTER TABLE `mae_asociado`
...
--
-- Filtros para la tabla `mae_usuarios_empleados`
--
ALTER TABLE `mae_usuarios_empleados`
...
--
-- Filtros para la tabla `sys_session`
--
ALTER TABLE `sys_session`
