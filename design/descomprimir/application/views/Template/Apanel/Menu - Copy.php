<?php
	...
	$logo					=	json_decode(@$empresa->logo_json);
	//pre($empresa);return;
	if(!empty($logo->upload_data->orig_name)){
		$me_logo=image("uploads/".$logo->upload_data->orig_name);
	}else{
		$me_logo=DOMINIO.'images/No_image.png';
	} 	
	...
	if(!empty($this->user->logo)){
		$img_perfil	=	image("uploads/".$this->user->logo);                       
	}else{
		$img_perfil	=	DOMINIO.'images/No_image.png';
	}
	//echo $me_logo;return;
?>
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item <?php if($this->uri->segment(1)==$this->ModuloActivo && !$this->uri->segment(2)){ echo 'active';}?>" style="margin-right:20px;">
                        <a class="nav-link">
                        	<?php
                                if(!empty($logo->upload_data->orig_name)){
									echo image("uploads/".$logo->upload_data->orig_name,true,false,array("class"=>"rounded mx-auto d-block","alt"=>'...'));
                                }else{
                            ...
                            <div class="contenido">
                                ...
                                <div class="item">
                                    <div id="botones" class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                        ...
                                        <div class="btn btn-default" id="cropper" href="<?php echo base_url("Configuracion/ModificarImagen")?>">
