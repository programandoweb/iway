	            ...
	            <div class="row form-group">
	                ...
	                <div class="col-md-4">	
                    	<div id="cropper">
							...
							?>
                            		<img src="<?php echo image("uploads/perfiles/".$this->user->user_id.'/logo.jpg',false,false); ?>" />
                            <?php
                            	}else{
							?>
                            		<img src="<?php 	echo img_logo($this->uri->segment(3));?>" />
                            <?php		
								}
							?>
                        </div>                    	
...
<script>
	var croppicContainerEyecandyOptions = {
		...
		uploadUrl:'<?php echo base_url("Configuracion/Add_Logo_Ajax/".$this->uri->segment(3)."/logo")?>',
		cropUrl:'<?php echo base_url("Configuracion/Save_Logo_Ajax/".$this->uri->segment(3)."/logo")?>',
		imgEyecandy:false,	
		modal:true,
