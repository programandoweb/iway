    	...
    	<div class="col-md-8">
        	<div class="form">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                     	<div class="input-group">	
                            <input type="text" class="form-control" name="factor_bonificacion" readonly="readonly" id="factor_bonificacion"  placeholder="Factor Bonificación" value="<?php echo (isset($row->factor_bonificacion))?$row->factor_bonificacion:''?>" require  />
                            <span class="input-group-addon" >%</span>
                        </div>
                    </div>
                </div>
