	...
	<div class="row justify-content-md-center">
    	<div class="col">
        	<div class="row filters">
            	<div class="col-md-6">
		            <h4 class="font-weight-700 text-uppercase orange"> Resumen Entrevistas.</h4>
                </div>
           	</div>
            <div class="row">
                <div class="col-md-12">
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="180" class="text-center">Test Psicotécnico</th>
                                            <th width="180" class="text-center">Test Inglés</th>
                                            <th width="180" class="text-center">Test Digitación</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
