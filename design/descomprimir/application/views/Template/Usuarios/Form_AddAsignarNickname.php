...
$hidden 	= 	array("centro_de_costos"=>$user2->centro_de_costos,"id_modelo"=>$this->uri->segment(3),'nickname_id' => (isset($row->nickname_id))?$row->nickname_id:'');
...
<script>
	$(document).ready(function(){
		...
		if($("#id_plataforma").val()=='00000000017' || $("#id_plataforma").val()=='00000000156' || $("#id_plataforma").val()=='00000000155' || $("#id_plataforma").val()==''){
