...
<?php
	...
	$HonorariosModelo			=	RP_HonorariosModelo($this->$modulo->result->user_id,$ciclo_informacion,$escala_escala_x_user_id);
	...
	$totalRQ					=	0;
	$totalP						=	0;
	$Rp['RP_OtrosIngresos']		=	RP_OtrosIngresos($this->$modulo->result->user_id,$escala_escala_x_user_id,$DiasTrabajados);
	$Rp['RP_Descuentos']		=	RP_Descuentos($this->$modulo->result->user_id,$escala_escala_x_user_id,$DiasTrabajados);
?>
<div class="container">
            ...
            <div class="row">
            	<div class="col-md-12">
                	<table class="table table-hover">
                        ...
                        <tbody>
                        	<?php foreach($HonorariosModelo['rows'] as $v){?>
                                <tr>
                                    <td>
										<?php 
                                    ...
                                    <td class="text-right">
										<?php 
											print_r(format($v->conversion,false));
										?>
									</td>
									<td class="text-right">
                                    	<?php
											print(format( $v->conversion_total,false));
										?>
                                    </td>
                                </tr>
                            <?php }?>
                        ...
                        <tfoot>
                        	<tr>
                                ...
                                <td class="text-right">
                                	<b>
                                	<?php echo format($HonorariosModelo['totales']['totalRQ'],false);?>
                                    </b>
                                </td>
                                <td class="text-right">
                                	<b>
										<?php
											echo format($HonorariosModelo['totales']['totalP'],false);
										?>
									</b>
								</td>
                                <td class="text-right"><b><?php echo format($HonorariosModelo['totales']['totalP_menos_totalRQ'],false);?></b></td>
                            </tr>
                        </tfoot>
					</table>                        
                </div>
            	...
            	<div class="col-md-12">
                	<table class="table table-hover">
						...
						<tbody>
							<?php
								$valor_total	= 0;
								if(count($Rp['RP_OtrosIngresos']['rows'])>0){
									foreach($Rp['RP_OtrosIngresos']['rows'] as $v){
                        ...
                        <tfoot>
                        	<tr>
                                ...
                                <td class="text-right"><b><?php echo format($Rp['RP_OtrosIngresos']['Totales']['TotalOtrosIngresos'],true);?></b></td>
                            </tr>
                        </tfoot>
					</table>                      
                </div>
                	...
                	<table class="table table-hover">
						...
						<tbody>
							<?php
								...
								$total_monto_cuota	=	0;
								$total_restante		=	0;
								if(count($Rp['RP_Descuentos']['rows'])>0){
									foreach($Rp['RP_Descuentos']['rows'] as $v){
                        ...
                        <div class="col-md-3 text-right">
                            <b>
                                <?php 
									...
									pre($aux);
									pre($bonificacion);
									pre($ortros_ingresos->valor);
									pre($total_ahorro_prima);*/
