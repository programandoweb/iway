...
<div class="container">
	<div class="row justify-content-md-center">
    	<div class="col">
            	...
            	<div class="col-md-6">
		            <h4 class="font-weight-700 text-uppercase orange">Gastos.</h4>
                </div>
                <div class="col-md-6 text-right">
                	<a class="btn btn-primary btn-md lightbox <?php if(empty($ciclo_informacion)){echo 'disabled';}?> " title="Gastos" data-type="iframe" href="<?php echo base_url($this->uri->segment(1)."/Add_Factura2")?>"><i class="fa fa-plus" aria-hidden="true"></i> Agregar</a>
