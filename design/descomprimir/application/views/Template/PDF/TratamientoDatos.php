...
<div style="font-family:font-family: 'Montserrat', sans-serif; line-height:16px; font-size:16px; text-align:center;font-family:font-family: 'Montserrat', sans-serif; ">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <td style="text-align:right;" valign="top">
                ...
                <?php echo $empresa->tipo_identificacion;?>:<?php echo $empresa->identificacion;?>-<?php echo $empresa->identificacion_ext;?>
                <?php # pre($empresa);?>
            </td>
        </tr>
    </table>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:20px;">
        <tr>
            <td style="text-align:center; ">
                Autorización para el uso, recolección y tratamiento de datos personales para <b><?php echo $empresa->nombre_legal?></b>
            </td>        
        </tr>
    </table>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:20px;">
        <tr>
            <td style="text-align:justify; font-size:12px;">
                ...
                información que sea de utilidad en los vínculos contractuales en los que sea parte el entrevistado, contratista, proveedores 
                y/o empleado titular de la información, b) dar cumplimiento de las obligaciones contraídas por 
                <b><?php echo $empresa->nombre_comercial?></b> con el entrevistado, contratista, proveedores y/o empleados titulares de la información, 
                ...
                proveedores y/o empleado titular de la información, d) evaluar la calidad de los servicios ofrecidos 
                por el entrevistado, contratista, proveedores y/o empleado titular de la información, 
                e) realizar estudios internos sobre los hábitos del entrevistado, contratista, proveedores y/o 
                empleado titular de la información para programas de bienestar corporativo, f) 
                realizar los descuentos de dinero autorizados por el entrevistado, contratista, proveedores y/o empleado  titular de la información,
                g) autorizar de manera irrevocable y por un periodo de diez (10) años desde la fecha del presente documento, 
                publicar en la base de datos del aplicativo webcamplus en su página www.webcamplus.com.co, mi estado actual, desempeño, 
                ...
                empresas del campo del entretenimiento para adultos puedan saber mi estado real, 
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:20px;">
        <tr>
            <td style="text-align:justify; ">
                <b>Datos sensibles</b>: El entrevistado, contratista, proveedores y/o empleado titular de la información o representante 
                legal manifiesta que conoce, acepta y autoriza de manera libre y espontánea que el tratamiento de la 
                información relativa a pertenencia a sindicatos, organizaciones sociales, a la salud, a la vida sexual y datos biométricos, 
                que sea necesaria para el cumplimiento de la finalidad anteriormente descritas basado en lo establecido en la presente 
                autorización. De conformidad con lo dispuesto en la Ley Estatutaria 1581 de 2012, 
                los datos personales que obtenga <b><?php echo $empresa->nombre_comercial?></b> por parte del entrevistado, contratista, proveedores y/o 
                empleado titular de la información o representante legal, serán recogidos y almacenados y objeto de tratamiento 
                en bases de datos hasta la terminación del vínculo contractual entre el entrevistado, contratista, proveedores y/o 
                empleado titular de la información y <b><?php echo $empresa->nombre_comercial?></b> y durante cinco (5) años más. 
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:20px;">
        <tr>
            ...
            <td>
                <div style="height:100px; width:80px;border:solid 1px #333; text-align:center; position:relative;">
...
<div style="position:absolute; bottom:5px; width:100%; font-size:16px; text-align:center;font-family:font-family: 'Montserrat', sans-serif;">
	<?php echo $empresa->direccion?>
    <br />
    <?php echo $empresa->website?>
</div>