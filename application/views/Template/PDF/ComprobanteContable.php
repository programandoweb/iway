...
<div style="font-family:font-family: 'Montserrat', sans-serif; line-height:16px; font-size:12px; font-family:font-family: 'Montserrat', sans-serif;margin-bottom: 80px;">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="table">
        <thead>
            <tr width="540">
                <th width="108">Cuenta</th>
                <th width="216">Descripción</th>
                <th width="108">Débito</th>
                <th width="108">Crédito</th>
            </tr>
        </thead>
        <tbody>
       			<?php 
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="table">
        <thead>
            <tr width="540">
                <th width="432">Procesador de pago</th>
                <th width="108">Valor</th>
            </tr>
        </thead>
        <tbody>
           <?php 
