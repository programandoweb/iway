...
<div style="font-family:font-family: 'Montserrat', sans-serif; line-height:16px; font-size:10px; font-family:font-family: 'Montserrat', sans-serif;text-align: justify;">
    ...
    <div style="height: 20px;"></div>
        ...
        <p style="margin-top: 40px;"><b>Consideración # 016: LA EMPRESA</b> hace especial claridad a <b>LA (EL) MODELO</b> respecto a la posibilidad de ser vista en Colombia a través de mecanismos virtuales o programas informáticos diseñados para tal fin, igualmente <b>LA (EL) MODELO</b> certifica que ha sido informada por <b>LA EMPRESA</b> de manera detallada respecto a la posibilidad de quedar información (imágenes o videos) de los shows realizados con su o sus Usuarios - nombre sustituto adoptado por <b>LA (EL) MODELO</b> frente a la web con el fin de preservar su identidad -  en diversos servidores los cuales NO son administrados, ni tiene competencia <b>LA EMPRESA</b>, situación que <b>LA (EL) MODELO</b> ha aceptado.</p>
        ...
        <table class="ancho" border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr class="colorFondo">
                <th width="15%">Nombre de la pagina</th>
                <th width="10%">Moneda Virtual</th>
                <th width="15%">Equivalencia en dólares norteamericanos</th>
                <th width="20%">Porcentaje pago LA (EL) MODELO</th>
                <th>Formula pago</th>
            </tr>
            <?php
            if(count($Otra)>0){  
                foreach ($Otra as $k2 => $v2) {?>
            <tr>
                <td class="bordeAll"><?php echo $v2->primer_nombre?></td>
                <td class="bordeAll"><?php echo $v2->moneda_de_pago?></td>
                <td class="bordeAll" style="text-align: center;">USD <?php echo $v2->equivalencia?></td>
                <td class="bordeAll" style="text-align: center;">50%</td>
                <td class="bordeAll" style="text-align: center;">(TRM dia x 0.88)x <?php echo $v2->equivalencia?> USD x 50%</td>
            </tr>
            <?php
                }
            }else{?>
            <tr>
                <td colspan="5" style="text-align: center;height: 18px;" class="bordeAll"> </td>
            </tr>
            <?php
            }
            ?>
        ...
        <div style="height: 20px;"></div>
        <p><b>PARÁGRAFO PRIMERO:</b> Acuerdan, aceptan y entienden <b>LAS PARTES</b> que la columna de la tabla anterior denomina <b>“Porcentaje pago LA (EL) MODELO”</b> corresponde al porcentaje máximo que <b>LA (EL) MODELO</b> percibirá al momento de la liquidación de sus utilidades en cada periodo de pago, de igual manera la columna denomina <b>“FORMULA DE PAGO”</b>; en donde se cita “TRM día”; corresponderá a la tasa representativa del mercado del día <b>DIECISEIS</b> para el periodo de pago comprendido del uno (1) al día quince (15) del mes (incluido), y el día <b>PRIMERO</b> para el período de pago comprendido del dieciséis (16) al último día del mes (incluido), aclarando que los días comienzan a las 12:00:01 am hora del pacífico y terminan 11:59:59 pm hora del pacífico.</p>

        <p><b>PARÁGRAFO SEGUNDO:</b> Acuerdan, aceptan y entienden las partes que del total facturado por medio de la página Camdolls® (www.es.camdolls.com) como política interna liquida una cantidad de dólares aproximado del sesenta por ciento (60%) y el cuarenta por ciento (40%) lo deja como remanente para liquidar el siguiente corte y así de forma progresiva hasta el retiro final de <b>LA (EL) MODELO</b> de la página, por lo cual <b>LA EMPRESA</b> liquidará de esta misma manera cada ciclo de facturación.</p>

        <p><b>PARÁGRAFO TERCERO:</b> Acuerdan, aceptan y entienden las partes que <b>LA EMPRESA</b> cuenta con espacios de transmisión adecuadamente acondicionados con todas las herramientas necesarias requeridas para un buen resultado de facturación quincenal, por lo cual será responsabilidad de <b>LA (EL) MODELO</b> dejar en impecables condiciones las instalaciones o áreas de trabajo, libres de aceite, basura o demás elementos, por lo anterior estará <b>LA EMPRESA</b>  autorizado para descontar cualquier daño al inventario </p>

        <p>generado con dolo o intención, incluyendo accidentes que se hubieran podido prevenir y que por culpa directa de <b>LA (EL) MODELO</b> desencadenaron en un daño a los bienes de <b>LA EMPRESA</b>, las partes acuerdan que <b>LA (EL) MODELO</b> escogerá como horario de transmisión el turno de la 
            <b><?php
                if($v->turno_manama != 0){
                    echo 'Mañana';
        ...
        <p>En constancia de lectura, conformidad, aceptación y ejecución se firma en la ciudad de <b><?php echo $empresa->ciudad ?></b> el día 
        <b><?php echo __setlocale($v->fecha_contratacion);	?>
		</b>.</p>
        <table class="ancho" border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
