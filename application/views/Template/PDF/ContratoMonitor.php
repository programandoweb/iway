...
<?php foreach ($this->$modulo->result as $k => $v) { ?>
    ...
    <div style="height: 20px;"></div>
        ...
        <p><b>Consideración # 004: LA (EL) CONTRATISTA</b> comprende que <b>LA EMPRESA</b> cuenta con un sistema de monitoreo interno donde </p>
        <p><b>Consideración # 005: LA (EL) CONTRATISTA</b> comprende que <b>LA EMPRESA</b> cuenta con un sistema de monitoreo interno donde podrá acceder en cualquier momento y sin previo aviso a la transmisión en vivo, por lo cual <b>LA (EL) CONTRATISTA</b> autoriza desde ahora y de forma irrevocable por el tiempo que dure este contrato a cualquier funcionario competente de <b>LA EMPRESA</b> o quien haga sus veces para el respectivo monitoreo, control de calidad y seguimiento.</p>
        ...
        <p style="padding-left: 30px;">
            ...
            c.  El cumplimiento con las condiciones legales impuestas al momento de la contratación y su alcance contractual, así como el respeto por la compañía, su imagen y el buen nombre tanto en las actividades laborales, comerciales y civiles como por fuera de las mismas.<br>
