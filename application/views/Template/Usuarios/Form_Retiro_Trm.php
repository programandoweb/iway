        	...
        	<div class="form">
	            <div class="row form-group item">
	                <div class="col-md-12 text-center">
		            	<h3>Información Básica Cliente</h3>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-3">	
	                    <div class="input-group input-group-sm">
	                        <input type="text" class="form-control col-md-4 salto" data-salto="Num" name="cod_telefono" maxlength="3"  value="<?php echo (isset($row->cod_telefono))?$row->cod_telefono:''?>" require />
                        	<input id="Num" data-salto="end" type="text" class="form-control col-md-8" name="telefono"  maxlength="10"  value="<?php echo (isset($row->telefono))?$row->telefono:''?>" require />                            
                        </div>
                    </div>
                    <div class="col-md-3 text-right">	
                    	<b>Número Fijo</b>
                    ...
                    <div class="col-md-3">	
                        <div class="input-group input-group-sm">
                            <input type="text" class="form-control col-md-4 salto" data-salto="Fijo" name="cod_otro_telefono" maxlength="3" value="<?php echo (isset($row->cod_otro_telefono))?$row->cod_otro_telefono:''?>" />
                            <input id="Fijo"  data-salto="end" type="text" class="form-control col-md-8" name="otro_telefono"  maxlength="10" value="<?php echo (isset($row->otro_telefono))?$row->otro_telefono:''?>" />                            
                        </div>
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-md-2">	
                    	<?php echo MakeEstadoCivil("estado_civil",(isset($row->estado_civil))?$row->estado_civil:NULL,array("class"=>"form-control","require"=>"require"));?>
                    </div>
                </div>
                <?php
                	echo direccion($row);
                ...
                <?php 
					...
					if($this->centro_costo || $this->user->centro_de_costos){
                        ...
                        <div class="row form-group item">
                            ...
                            <div class="col-md-6">
	                            <?php set_input("porcentaje_participacion",$row,$placeholder='Porcentaje de participación',$require=true);?>
                            </div>
						</div>
                        <div class="row form-group">                    
                            <div class="col-md-6 text-right">	
