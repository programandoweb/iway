                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-3">	
	                    <div class="input-group input-group-sm">
                        	...
                        	<?php 	
                                if(!isset($row->cod_telefono)|| $this->user->type=='root'){set_input("cod_telefono",$row,$placeholder='',$require=true," col-md-4 salto",array("maxlength"=>"3","data-salto"=>"telefono"));}
                                else{?><h5>(<?php echo $row->cod_telefono;?>) </h5><?php }
                            ?>
                            <?php 	
                                if(!isset($row->telefono)|| $this->user->type=='root'){set_input("telefono",$row,$placeholder='Teléfono',$require=true," col-md-8 ",array("maxlength"=>"10","data-salto"=>"end"));}
                    ...
                    <div class="col-md-3">	
                        <div class="input-group input-group-sm">
	                        <?php 	
                                if(!isset($row->cod_otro_telefono)|| $this->user->type=='root'){set_input("cod_otro_telefono",$row,$placeholder='',""," col-md-4 salto",array("maxlength"=>"3","data-salto"=>"otro_telefono"));}
                                else{?><h5>(<?php echo @$row->cod_otro_telefono;?>) </h5><?php }
                            ?>
                            <?php 	
                                if(!isset($row->otro_telefono)|| $this->user->type=='root'){set_input("otro_telefono",$row,$placeholder='',""," col-md-8 salto",array("maxlength"=>"10","data-salto"=>"end"));}
