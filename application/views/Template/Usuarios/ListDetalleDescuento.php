            ...
            <div class="row">
            	<div class="col-md-12">
					<table class="ordenar display table table-hover">
						<thead>
							<tr>
								<th width="140"><b>Nombre</b></th>
                                <th width="100" class="text-center"><b>Concepto</b></th>
                                <th  width="150" class="text-center"><b>Observacion</b></th>
                                <th width="100" class="text-right"><b>Quincenas</b></th>
