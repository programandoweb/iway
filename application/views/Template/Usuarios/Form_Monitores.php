...
$hidden     =   array('type'=>$this->uri->segment(3),'user_id' => (isset($row->user_id))?$row->user_id:'',"redirect"=>base_url("Usuarios/Todos/".$this->uri->segment(3)),"fecha_creacion"=>$now->format('Y-m-d H:i:s'),"id_responsable"=>$this->user->user_id);
        ...
        <div class="col-md-8">
            <div class="form">
                ...
                <div class="row form-group">                    
                    ...
                    <div class="col-md-6 "> 
                        <?php
                            if(empty($row)){$data = array("data-dependiente"=>"dependiente","data-action"=>base_url("Usuarios/SearchUser"),"data-sucursal"=>strtolower($centro_de_costos->abreviacion)); 
                            }else{
                                $data = "";
                            } 
                ...
                <div>
                    ...
                    <div class="row form-group">                    
                        <div class="col-md-6 text-right">   
                            <b>Bonificación Cumplimiento</b>
                        </div>
                        <div class="col-md-3">
                            <h6 class="">Si</h6>  
                            <?php
                                set_input_radio("json[Bonificacion_cumplimiento]",'',"Si",((@$json->Bonificacion_cumplimiento == "Si")?true:false),'custom-control-input',null);
                            ?>
                        </div>
                        <div class="col-md-3">
                            <h6 class="">No</h6>  
                            <?php
                                set_input_radio("json[Bonificacion_cumplimiento]",'',"No",((@$json->Bonificacion_cumplimiento == "No")?true:false),'custom-control-input',null);
                            ?>
                        </div>
                    </div>
                    <div class="row form-group item">
