    	...
    	<div class="col-md-12">
        	<div class="form">
	            ...
	            <div class="row form-group" id="contenedor_master">
                    ...
                    <div class="col-md-6">	
                       	<?php 
							echo modelo($row, $estado = null,$extra=array("class"=>"form-control","placeholder"=>"Modelo"));
						?>
                    </div>
                    <div class="col-md-6 offset-md-3 advertencia"></div>
				</div> 
                <div class="row form-group">
	                <div class="col-md-3 text-right">	
                    	<b>Página *</b>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">	
	                    ...
	                    <?php set_input("nickname",@$row,'Nickname',false,"validar",array("readonly"=>"readonly"));?>
                    </div>
                    <div class="col-md-6 offset-md-3 advertencia"></div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group item">
                    ...
                    <div class="col-md-6">	
                        <?php 
							echo MakeEstado("estado",(isset($row->estado) && $row->estado!=0)?$row->estado:1,array("class"=>"form-control validar","require"=>"require"));?>
                    </div>
                    <div class="col-md-6 offset-md-3 advertencia"></div>
				</div>
                <div class="row">
...
<script>
	$(document).ready(function(){
        validar_form_sin_require('.validar');
