<?php
	...
	$pasos			=	$this->uri->segment(5,1);
	$next			= 	$pasos+1;
	$btn_adelante	=	base_url("Formularios/Entrevista/PrimerBloque/Pasos/".$next);
    ...
    <div class="section" style="background-color:#e9e9e9;">
        <div class="row ">
            <div class="col" style="min-height:300px;">
				<?php
					$file=PATH_VIEW.'/Template/Formularios/Entrevista/Pasos/'.$this->uri->segment(5,1).'.php';
					if(file_exists($file)){
						$this->load->view("Template/Formularios/Entrevista/Pasos/".$this->uri->segment(5,1),array("empresa",$this->user->empresa));
					}
                ?>
            </div>
        </div>
                ...
                <div class="form-group text-center">
                	<?php
                    	if($pasos>2 && $pasos<19){
							$atras=$pasos-2;
					?>
                    	<a class="btn btn-primary" href="<?php echo base_url("Formularios/Entrevista/PrimerBloque/Pasos/". $atras);?>">
                            Anterior	    
                        </a>
                    <?php
						}
					...
					?>
                        <a class="btn btn-primary" href="<?php echo base_url("Formularios/Examen/Examen")?>">
                            Pasar a la parte 2 de la entrevista
                        </a>
                    <?php		
						}
					?>
