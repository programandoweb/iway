...
<div class="tab-content col-md-12"> 
 ...
 <div class="tab-pane col-md-12" id="paso2" role="tabpanel">
                      ...
                      <div id="preguntas" class="row col-md-12">
...
<?php  echo form_open(current_url()); ?>
                                  <input id="Examen" type="hidden" name="json_respuestas" require="true" value="0">
...
var fecha = Date.parse('<?php $fecha = inicioReloj($this->uri->segment(3)); echo $fecha->fecha; ?>');
