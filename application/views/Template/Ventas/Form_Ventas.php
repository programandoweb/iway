...
if(empty($this->$modulo->result)){
    ...
    if(@$row->caja_compensacion > 0){
        $data['caja_compensacion'] = "Si";
    }else{
        $data['caja_compensacion'] = "No";
    }
    if(@$row->pension > 0){
        $data['pension'] = "Si";
    }else{
        ...
        <div class="col-md-8">
            <div class="form">
                ...
                <!--<div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            <?php set_input("salario",@$row,$placeholder='Salario',$require=true,"money");?>
                    ...
                    <div class="col-md-6">  
                        <div class="input-group">
                            <?php 
                                ...
                                set_input("eps",format(@$row->$eps,true),$placeholder='EPS',$require=false,"money option-true",array("style"=>"display:none","readonly"=>"readonly"));?>
                            <span class="input-group-addon option-true" style="display: none">COP</span>
                            <button type="button" class="btn btn-secondary opcion" data-opcion="Si" data-active='<?php echo $eps; ?>'>SI</button>
                            <button type="button" class="btn btn-secondary opcion" data-opcion="No" data-active='<?php echo $eps; ?>'>NO</button>
                        </div>                            
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-md-6">  
                        <div class="input-group">
                            <?php
                                ...
                                set_input("arl",format(@$row->$arl,true),$placeholder='ARL',$require=false,"money option-true",array("style"=>"display:none","readonly"=>"readonly"));?>
                            <span class="input-group-addon option-true" style="display: none">COP</span>
                            <button type="button" class="btn btn-secondary opcion" data-opcion="Si" data-active='<?php echo $arl; ?>'>SI</button>
                            <button type="button" class="btn btn-secondary opcion" data-opcion="No" data-active='<?php echo $arl; ?>'>NO</button>
                        </div>
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-md-6">  
                        <div class="input-group">
                            <?php
                                if(isset($row->caja_compensacion)){
                                    $caja = "caja_compensacion";
                                }else{
                                    $caja = "Costo_caja_comp_Familiar";
                                }

                                set_input("caja_compensacion",format(@$row->$caja,true),$placeholder='Caja Compensación',$require=false,"money option-true",array("style"=>"display:none","readonly"=>"readonly"));?>
                            <span class="input-group-addon option-true" style="display: none">COP</span>
                            <button type="button" class="btn btn-secondary opcion" data-opcion="Si" data-active='<?php echo $caja; ?>'>SI</button>
                            <button type="button" class="btn btn-secondary opcion" data-opcion="No" data-active='<?php echo $caja; ?>'>NO</button>
                        </div>
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-md-6">  
                        <div class="input-group">
                            <?php
                                if(isset($row->pension)){
                                    $pension = "pension";
                                }else{
                                    $pension = "Costo_pension";
                                } 
                                set_input("pension",format(@$row->$pension,true),$placeholder='Pensión',$require=true,"money option-true",array("style"=>"display:none","readonly"=>"readonly"));?>
                            <span class="input-group-addon option-true" style="display: none">COP</span>
                            <button type="button" class="btn btn-secondary opcion" data-opcion="Si" data-active='<?php echo $pension; ?>'>SI</button>
                            <button type="button" class="btn btn-secondary opcion" data-opcion="No" data-active='<?php echo $pension; ?>'>NO</button>
                        </div>
                    </div>
                </div>-->
                <div class="row form-group">
