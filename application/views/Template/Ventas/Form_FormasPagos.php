    	...
    	<div class="col-md-8">
        	<div class="form">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">	
                        <input type="text" class="form-control" name="nombre_escala"  placeholder="Nombre Escala" value="<?php echo (isset($row->nombre_escala))?$row->nombre_escala:''?>" <?php echo (isset($row->nombre_escala))?'
                        ':''?>  require/>
                    </div>
                </div>
                <div class="row form-group">
