<?php
  ...
  /*LO COMENTÉ PORQUE NO LE ENCUENTRO SENTIDO*/
  ...
  $hidden   =   array('user_id' => (isset($row->user_id))?$row->user_id:'',
                      'empresa_id' =>(isset($row->id))?$row->id:'',
                      'rol_id' =>(isset($row))?$row->regimen_empresa:'',
                    );
  echo form_open(current_url(),array('ajaxing' => 'true'),$hidden);
?>
    <div class="container-fluid pr-0 pl-0 mt-4 iframer">
                            ...
                            <div class="row form-group">
                                <div class="col-md-6">
                                  ...
                                  <?php
                                      ...
                                      set_input("username",@$row,$placeholder='Nombre Usuario',$require=true,'',array("id"=>"username","data-content"=>"#respuesta_query_login","data-url"=>base_url("api/get?modulo=Usuarios&m=SearchUser&formato=json&query=")));
                                      import("js","pgrw.search");

                                  ?>
                                  <input type="hidden" id="continuar_wizard" required="required">
                                  <?php if(!isset($row)){?>
                                    <input type="hidden" id="url" value="<?php echo base_url() ?>">
                                  <?php }?>
                                </div>
                                <div class="col-md-6" id="respuesta_query_login">
                                </div>
                            </div>
                            <div class="row form-group">
                            <div class="col-md-6">
