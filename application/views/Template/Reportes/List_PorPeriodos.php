                                                                            ...
                                                                            if(isset($terceros_x_turnos[$k])){
                                                                                foreach($terceros_x_turnos[$k] as $k2 => $v2){
																					...
																					if(@$RP_X_Modelos->credito>0){
																						$reporte_x_modelo[$v2->user_id][$a][1]		=	$RP_X_Modelos->credito / 0.05;
                                                                	...
                                                                	<?php 
                                                                            if(isset($terceros_x_turnos[$k])){
                                                                                foreach($terceros_x_turnos[$k] as $k2 => $v2){
																					...
																					if(@$RP_X_Modelos->credito>0){
																						$reporte_x_modelo[$v2->user_id][$a][2]		=	$RP_X_Modelos->credito / 0.05;
																						@$cantidad_items_verticales[$a][1]			+=	(@$RP_X_Modelos->credito / 0.05);
																						@$cantidad_items_horizontales[$k][$k2]		+=	(@$RP_X_Modelos->credito / 0.05);
																						print('<div>'.format($RP_X_Modelos->credito / 0.05,false).'</div>');
																					}else{
																...
																?>
                                                                    <td class="dias text-right">
                                                                        <?php 
																			if(isset($modelos["x_rooms"][$k])){
																				foreach($modelos["x_rooms"][$k] as $k2 => $v2){
																					if(isset($reporte_x_modelo[$v2->user_id][$a][1])){
																						@$cantidad_items_verticales[$a][1]	+=	$reporte_x_modelo[$v2->user_id][$a][1];
																						@$suma_horizontal[$v2->user_id]	+=	$reporte_x_modelo[$v2->user_id][$a][1];	
																						print('<div>'.format($reporte_x_modelo[$v2->user_id][$a][1],false).'</div>');	
																					}else{
																						echo '<div>---</div>';	
																					}
																				}
                                                                    ...
                                                                    <td class="dias text-right">
                                                                	    <?php 
																			if(isset($modelos["x_rooms"][$k])){
																				foreach($modelos["x_rooms"][$k] as $k2 => $v2){
																					if(isset($reporte_x_modelo[$v2->user_id][$a][2])){
																						@$cantidad_items_verticales[$a][2]	+=	$reporte_x_modelo[$v2->user_id][$a][2];
																						@$suma_horizontal[$v2->user_id]	+=	$reporte_x_modelo[$v2->user_id][$a][2];	
																						print('<div>'.format($reporte_x_modelo[$v2->user_id][$a][2],false).'</div>');	
																					}else{
																						echo '<div>---</div>';	
																					}
																				}
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr id="tr_item2_<?php echo $k;?>">
                                                        ...
                                                        <td>
                                                            <?php 
                                                                if(!empty($masters[$plataforma_id])){
