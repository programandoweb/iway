                        		...
                        		<div role="tabpanel" class="tab-pane fade active show" id="home" aria-labelledby="home-tab">
                                	<div>
										<table class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php 
													$total_general_pantalla2	=0;
                                                    foreach($this->$modulo->result["global"] as $k => $v){
                                                        if(is_object($v) && isset($sum_x_modelos_total2[$v->primer_nombre])){
															$total_general_pantalla2	+=	@$sum_x_modelos_total2[$v->primer_nombre];
                                                ?>
                                            ...
                                            <tfoot>
                                                ...
                                                <td class="text-right"><b><?php print(format(@$total_general_pantalla2,false));?> </b></td>
                                            </tfoot>
                                        </table>
                                    </div>
                        		</div>
