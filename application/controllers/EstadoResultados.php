                            ...
                            <div class="tab-content" id="myTabContent">
                              	<div role="tabpanel" class="tab-pane fade active show" id="item1" aria-labelledby="item-tab" aria-expanded="false">
                                    <div id="controls" class="d-flex">
                                        <i class="fas fa-arrow-alt-circle-left pl-4 pt-2 pb-2 mr-auto" id="retroceder" style="font-size: 20px;cursor: pointer;"></i>
                                        <i class="fas fa-arrow-alt-circle-right pr-4 pt-2 pb-2 ml-auto" id="avanzar" style="font-size: 20px;cursor: pointer;"></i></div>
                                    <div id="resultados"></div>                                
								</div>
                                <div role="tabpanel" class="tab-pane fade" id="item2" aria-labelledby="item-tab" aria-expanded="false">  
                                    <div id="controls" class="d-flex">
                                        <i class="fas fa-arrow-alt-circle-left pl-4 pt-2 pb-2 mr-auto" id="retroceder2" style="font-size: 20px;cursor: pointer;"></i>
                                        <i class="fas fa-arrow-alt-circle-right pr-4 pt-2 pb-2 ml-auto" id="avanzar2" style="font-size: 20px;cursor: pointer;"></i></div>
...
<script>
    $(document).ready(function(){
        ...
        var calculo_desde2 = '<?php echo $calculo_desde; ?>';
        var cantidad_a_mostrar2 = '<?php echo $cantidad_a_mostrar; ?>';
        ...
        cargar_data2(calculo_desde2);
        function cargar_data2(calculo_desde2){
            $.post(url2,{calculo_desde:calculo_desde2,cantidad_a_mostrar:cantidad_a_mostrar2},function(data){
            },'json').fail(function() {
                make_message("Error","Este informe no pudo ser cagado por favor consulte al administrador de sistema");
            }).done(function(data2){
