...
class Finanzas_model extends CI_Model {
	...
	public function get_fi_cajas(){
		...
		$edit_close			=		'"><i class="fas fa-edit" aria-hidden="true"></i></a>';
		$this->fields		=		array("Tipo_de_Caja"=>"Tipo_de_Caja","codigo_contable_subfijo"=>"codigo_contable_subfijo","id_caja"=>"id_caja","codigo_contable"=>"codigo_contable","nombre_caja"=>"Nombre","CASE WHEN t1.estado=1 THEN 'Activo' ELSE 'Inactivo' END"=>"Estado"," CONCAT('".$edit_open."',id_caja,'".$edit_close."') AS edit"=>"Acción");
